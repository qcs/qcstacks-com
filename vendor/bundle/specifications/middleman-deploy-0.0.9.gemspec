...
Gem::Specification.new do |s|
  ...
  s.date = "2013-01-05"
  s.description = "Deploy a middleman built site over rsync or via git (e.g. gh-pages on github)."
  s.email = ["thomas.david.vaughan@gmail.com"]
  s.homepage = "http://tvaughan.github.com/middleman-deploy/"
  s.require_paths = ["lib"]
  s.rubygems_version = "1.8.23"
  s.summary = "Deploy a middleman built site over rsync or via git (e.g. gh-pages on github)."
